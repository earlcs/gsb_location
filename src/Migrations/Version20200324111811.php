 ...
 */
final class Version20200324111811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartements CHANGE NUMAPPART NUMAPPART INT AUTO_INCREMENT NOT NULL, CHANGE PRIX_LOC PRIX_LOC NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE PRIX_CHARG PRIX_CHARG NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE PREAVIS PREAVIS TINYINT(1) DEFAULT NULL, CHANGE NUMEROPROP NUMEROPROP INT DEFAULT NULL, CHANGE NUMEROLOC NUMEROLOC INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartements CHANGE NUMAPPART NUMAPPART INT NOT NULL, CHANGE PRIX_LOC PRIX_LOC NUMERIC(10, 0) NOT NULL, CHANGE PRIX_CHARG PRIX_CHARG NUMERIC(10, 0) NOT NULL, CHANGE PREAVIS PREAVIS TINYINT(1) DEFAULT \'0\', CHANGE NUMEROPROP NUMEROPROP INT NOT NULL, CHANGE NUMEROLOC NUMEROLOC INT NOT NULL');
