 ...
 */
final class Version20200226131203 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartements CHANGE NUMAPPART NUMAPPART INT AUTO_INCREMENT NOT NULL, CHANGE PREAVIS PREAVIS TINYINT(1) DEFAULT NULL, CHANGE NUMEROPROP NUMEROPROP INT DEFAULT NULL, CHANGE NUMEROLOC NUMEROLOC INT DEFAULT NULL');
