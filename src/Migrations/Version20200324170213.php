 ...
 */
final class Version20200324170213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartements CHANGE NUMAPPART NUMAPPART INT AUTO_INCREMENT NOT NULL, CHANGE ARRONDISSEMENT ARRONDISSEMENT INT DEFAULT NULL, CHANGE PREAVIS PREAVIS TINYINT(1) DEFAULT NULL, CHANGE NUMEROPROP NUMEROPROP INT DEFAULT NULL, CHANGE NUMEROLOC NUMEROLOC INT DEFAULT NULL');
        $this->addSql('ALTER TABLE appartements RENAME INDEX fk_arrondissement TO IDX_8876962BD1131EF9');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartements CHANGE NUMAPPART NUMAPPART INT NOT NULL, CHANGE PREAVIS PREAVIS TINYINT(1) DEFAULT \'0\', CHANGE ARRONDISSEMENT ARRONDISSEMENT INT NOT NULL, CHANGE NUMEROPROP NUMEROPROP INT NOT NULL, CHANGE NUMEROLOC NUMEROLOC INT NOT NULL');
        $this->addSql('ALTER TABLE appartements RENAME INDEX idx_8876962bd1131ef9 TO fk_arrondissement');
